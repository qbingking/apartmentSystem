<div class="row mb-2">
    <div class="col-12 col-lg-6 offset-lg-3">
        <div id="apm_service_info<?= $item_apm['id'] ?>" 
            ...
            data-interval="false">
                <div class="carousel-inner">
                    <?php for ($i= 0; $i < count($list_service["list_service"]); $i+= 5): ?>
                            <div class="carousel-item border rounded border-warning <?= $list_service['list_service'][$i]['key_service'] == 'dien'? 'active':'' ?>">
                                <ul class="list-group <?= in_array($district_key, $list_district_editable) != 0 ? 'service-info-editable':''  ?>">
                ...
                <a class="carousel-control-prev" href="#apm_service_info<?= $item_apm['id'] ?>" role="button" data-slide="prev">
                    <span class="mdi mdi-chevron-double-left" aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="carousel-control-next" href="#apm_service_info<?= $item_apm['id'] ?>" role="button" data-slide="next">
